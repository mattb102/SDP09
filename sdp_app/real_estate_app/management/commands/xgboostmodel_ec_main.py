...
df = pd.read_csv(str(input()))  # Update with the correct path
            ...
            for train_index, test_index in tscv.split(X):
                ...
                for decay_factor in decay_options:
                    ...
                    if loaded_model == 0:
                        ...
                        loaded_model.set_params(early_stopping_rounds=10)
                        loaded_model.fit(X_train, y_train, sample_weight=weights,
                                         eval_set=early_stopping, verbose=False)
